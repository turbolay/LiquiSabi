...
using NBitcoin.RPC;
using LiquiSabi.ApplicationCore.Utils.BitcoinCore.Configuration;
using LiquiSabi.ApplicationCore.Utils.BitcoinCore.Configuration.Whitening;
using LiquiSabi.ApplicationCore.Utils.BitcoinCore.Processes;
...
namespace LiquiSabi.ApplicationCore.Utils.BitcoinCore;
