using LiquiSabi.ApplicationCore.Utils.Gma.QrCodeNet.Encoding.Positioning.Stencils;

namespace LiquiSabi.ApplicationCore.Utils.Gma.QrCodeNet.Encoding.Positioning;
