using LiquiSabi.ApplicationCore.Utils.Gma.QrCodeNet.Encoding.DataEncodation.InputRecognition;
using LiquiSabi.ApplicationCore.Utils.Gma.QrCodeNet.Encoding.Terminate;
