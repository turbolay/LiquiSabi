...
using LiquiSabi.ApplicationCore.Utils.WabiSabi.Client.CredentialDependencies;
...
public class CoinJoinClient
{
	...
	{
		ImmutableArray<(AliceClient AliceClient, Tor.Socks5.Pool.Circuits.PersonCircuit PersonCircuit)> registeredAliceClientAndCircuits = ImmutableArray<(AliceClient, PersonCircuit)>.Empty;
		try
		{
			var roundId = roundState.Id;
